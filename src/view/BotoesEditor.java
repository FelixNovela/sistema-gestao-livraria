...
public class BotoesEditor extends AbstractCellEditor implements TableCellRenderer, TableCellEditor {
    ...
    public BotoesEditor(JTable tabela, LivroService livroService, DefaultTableModel modelo) {
        this.tabela = tabela;
    ...
    private void editarLivro() {
        ...
        if (linha != -1) {
            ...
            if (livro != null) {
                ...
                EditarLivro dialog = new EditarLivro(framePai, livro, livroService, modelo);
