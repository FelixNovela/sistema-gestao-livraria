...
import controller.vendedor.LivrosVendedorController;
import service.LivroService;
import view.cores.Cores;

public class LivrosVendedorView extends JPanel {
	...
	private LivrosVendedorController controller;

	public LivrosVendedorView() {
		...
		LivrosVendedorController controller = new LivrosVendedorController(this, new LivroService());
	}

	public void setController(LivrosVendedorController controller) {
	...
	private JScrollPane criarTabelaLivros() {
		String[] colunas = { "ISBN", "Título", "Autor", "Categoria", "Preco", "Estoque" };
