...
import controller.vendedor.ListaVendasVendedorController;
import service.VendaService;
import view.cores.Cores;

public class ListaDeVendasVendedorView extends JPanel {
    ...
    private ListaVendasVendedorController controller;

    public ListaDeVendasVendedorView(String nomeUser) {
        ...
        ListaVendasVendedorController controller = new ListaVendasVendedorController(this, new VendaService());
    }
    
    public void setController(ListaVendasVendedorController controller) {
    ...
    private JPanel criarHeader() {
        ...
        JLabel titulo = new JLabel("Lista De Vendas");
    ...
    private JPanel criarPainelPrincipal() {
        ...
        painel.add(criarTabelaListaVendas(), BorderLayout.CENTER);
        return painel;
    }
