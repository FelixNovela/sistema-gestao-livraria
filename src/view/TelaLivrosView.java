...
import java.awt.*;
import controller.TelaLivrosController;

public class TelaLivrosView extends JPanel {
    ...
    private TelaLivrosController controller;

    public TelaLivrosView() {
        ...
        TelaLivrosController controller = new TelaLivrosController(this, new LivroService());
    }
    
    public void setController(TelaLivrosController controller) {
