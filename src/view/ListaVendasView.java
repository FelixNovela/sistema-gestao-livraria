...
public class ListaVendasView extends JPanel {
    ...
    private ListaVendasController controller;
    ...
    public ListaVendasView() {
        ...
        ListaVendasController controller = new ListaVendasController(this, new VendaService());
    }
    
    public void setController(ListaVendasController controller) {
