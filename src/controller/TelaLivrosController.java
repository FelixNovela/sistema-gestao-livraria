...
public class TelaLivrosController {
    ...
    private TelaLivrosView view;
    private LivroService livroService;
    
    public TelaLivrosController(TelaLivrosView view, LivroService livroService) {
        this.view = view;
    ...
    private void configurarTabelaLivros() {
        ...
        tabela.getColumnModel().getColumn(6).setCellRenderer(new BotoesEditor(tabela, livroService, modeloTabela));
        tabela.getColumnModel().getColumn(6).setCellEditor(new BotoesEditor(tabela, livroService, modeloTabela));
    }
